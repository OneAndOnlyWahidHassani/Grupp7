...
public class World2Template extends WorldTemplate {
    ...
    public World2Template(int[][] levelArray, CampaignController campaignController, RightPanel rightPanel, AudioPlayer audioPlayer) throws FileNotFoundException {
        super(levelArray, campaignController, campaignController.getRightPanel(), campaignController.getAudioPlayer(), 35);
